...
--TINY map grid
terrainLayoutResult =
{ {g,  g,  p,  p,  p,  p,  p,  p,  p,  p,  g,  p,  p}
, {p,  h,  p,  p,  p,  p, r1, r1,  p,  p,  p,  p, r1}
, {p,  p,  p,  p, r1, r1,  p,  p, r1, r1,  p, r1,  p}
, {p,  p,  p, r1,  p,  p,  p,  p,  p,  p, r1,  p,  p}
, {p,  p, r1,  p,  p,  p,  p,  p,  p,  p,  p,  p,  p}
, {p,  p, r1,  p,  p,  p,  p,  p,  p,  w,  w,  p,  g}
, {j,  p,  p, r1,  p,  p,  p,  p,  p,  w,  w,  p,  p}
, {g,  p,  p, r1,  p,  p,  p,  p,  p,  p,  p,  p,  p}
, {p,  p,  p, r1,  p,  p,  p,  p,  p,  p,  p,  p,  p}
, {p,  p, r1,  p,  p,  p,  p,  g, p1, p1, p0, p1, p0}
, {r1, r1, p,  p,  p,  p, p1,  p,  g,  g,  g,  g,  g}
, {p,  p,  p,  g,  p,  m,  g,  g,  g,  g,  p,  g,  p}
, {p,  p,  p,  p,  p,  g,  g,  d,  g,  d,  g,  g,  d}
}
