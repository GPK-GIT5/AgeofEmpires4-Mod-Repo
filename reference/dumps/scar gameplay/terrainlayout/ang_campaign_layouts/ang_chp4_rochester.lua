...
l = { terrainType = tt_hills_lowland}
h = { terrainType = tt_hills_low_rolling}
t = { terrainType = tt_plateau_low}
...
--TINY map grid
terrainLayoutResult =
{ {p, r, p, p, p, p, p, p, p, p, p, g, g}
, {l, p, r, r, r, r, p, p, p, p, p, p, p}
, {h, p, p, p, p, p, r, r, p, p, p, p, p}
, {g, g, g, g, h, p, p, p, r, p, p, p, p}
, {g, p, l, h, h, l, l, g, g, r, p, p, p}
, {h, p, p, h, h, l, g, h, g, g, r, p, p}
, {l, g, h, h, h, p, l, g, g, g, p, r, p}
, {p, p, g, p, p, p, l, l, p, p, p, p, r}
, {g, p, p, p, p, p, p, p, p, p, p, p, r}
, {h, p, p, h, h, h, h, p, p, p, p, p, r}
, {h, p, p, p, p, p, p, p, p, p, p, p, r}
, {p, p, p, r, r, r, r, r, r, r, r, r, g}
, {p, p, r, p, p, p, p, l, g, g, g, g, g}
}
...
ChartRiver(r, {13, 3}, terrainLayoutResult)
...
--table.insert(fordResults, { riverResult[1][3], riverResult[1][20], riverResult[1][25], riverResult[1][13]  })
