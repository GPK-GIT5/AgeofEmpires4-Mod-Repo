...
--TINY map grid
terrainLayoutResult =
{ {	p,	p,	r1,	p,	g,	p,	p,	p,	r2,	c,	c,	c,	c	}
, {	p,	p,	r1,	p,	g,	p,	p,	p,	r2,	p,	g,	c,	c	}
, {	p,	p,	r1,	p,	g,	p,	p,	p,	r2,	p,	p,	c,	c	}
, {	p,	p,	r1,	p,	g,	p,	g,	p,	g,	r2,	p,	c,	c	}
, {	p,	p,	r1,	p,	g,	g,	p,	p,	p,	r2,	p,	g,	g	}
, {	p,	p,	r1,	p,	c,	c,	g,	p,	p,	r2,	p,	p,	g	}
, {	p,	p,	r1,	p,	p,	c,	c,	p,	p,	r2,	p,	p,	c	}
, {	p,	p,	r1,	p,	p,	g,	c,	c,	g,	g,	r2,	p,	g	}
, {	p,	p,	r1,	p,	p,	p,	g,	c,	p,	p,	r2,	p,	p	}
, {	p,	p,	p,	r1,	p,	p,	p,	c,	c,	g,	r2,	p,	g	}
, {	p,	p,	p,	p,	r1,	p,	p,	c,	c,	g,	p,	r2,	p	}
, {	g,	p,	p,	p,	p,	r1,	r1,	p,	g,	c,	c,	p,	r2	}
, {	p,	p,	g,	p,	p,	g,	p,	r1,	p,	c,	c,	p,	p	}	
}

--RIVERS
ChartRiver(r1, {13, 8}, terrainLayoutResult)
--ChartRiver(r2, {13, 8}, terrainLayoutResult)
ChartRiver(r2, {1, 9}, terrainLayoutResult)

--FORDS
table.insert(fordResults, { riverResult[1][5] })
--table.insert(fordResults, { riverResult[2][6] })
table.insert(fordResults, { riverResult[2][4], riverResult[2][7], riverResult[2][10] })
