...
local function main() 
	...
	--table.insert(highLevelWeightTable, {"SetupCentreMap", centreWeight, CreateSpecialMap})
	--table.insert(highLevelWeightTable, {"maze", specialWeight, CreateMazeMap})
	...
	if worldGetRandom() < 0.5 then
		...
		--50% for any market to spawn, or 50% for eacheach market
		if worldGetRandom() < 0.5 then
			-- no markets
		else
			-- 50% for each
...
CreateSpecialMap = function()
	...
	print("you have entered the MegaRandom WeirdZone") -- crashes 4v1v1v1
