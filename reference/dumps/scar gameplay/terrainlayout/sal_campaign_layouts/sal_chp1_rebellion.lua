...
-- TINY map grid
terrainLayoutResult =
{ {p,   p,   p,   p,   p,   p,   p,   p,  r1,   p,  r1,  r1,  p}
, {p,   h,   p,   p,   p,   p,   p,  r1,   p,  r1,   p,   p,  r1}
, {p,   p,   p,  r1,  r1,   p,  r1,   p,   p,   p,   p,   p,  p}
, {p,  r1,  r1,   p,   p,  r1,   p,   p,   p,   p,   p,   p,  r2}
, {r1,  p,   p,   p,   p,   p,   p,   p,   p,   p,   p,   r2, p}
, {p,   h,   p,   p,   p,   p,   r2,  p,   p,   p,   p,   r2, p}
, {p,   p,   p,   p,   p,   r2,  p,   r2,  r2,  r2,  r2,  p,  p}
, {r2,  p,   p,   p,   r2,  p,   p,   p,   p,   p,   p,   p,  p}
, {p,   r2,  r2,  r2,  p,   p,   p,   p,   p,   p,   p,   p,  p}
...
-- Init Rivers
ChartRiver(r1, {5, 1}, terrainLayoutResult)
ChartRiver(r2, {8, 1}, terrainLayoutResult)
