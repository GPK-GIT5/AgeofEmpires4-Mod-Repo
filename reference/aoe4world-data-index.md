...
|--------|-------|---------|
| [data/units/](../data/units/) | 1,266 | Unit statistics by civilization (per-civ JSON + unified + optimized variants) |
| [data/buildings/](../data/buildings/) | 861 | Building statistics by civilization (per-civ JSON + unified + optimized variants) |
| [data/technologies/](../data/technologies/) | 2,207 | Technology/upgrade data by civilization (per-civ JSON + unified + optimized variants) |
| [data/civilizations/](../data/civilizations/) | 23 | Civilization metadata (ID, name, abbreviation, expansion, attribName) |
...
3. Search `data/units/all.json` or `data/buildings/all.json` for `"attribName": "unit_archer_2_abb"`
4. Cross-check with `data/civilizations/` to validate civilization compatibility
...
2. Search civilization-specific JSON file (e.g., `data/units/abbasid.json`)
3. Validate `civs[]` array includes target civilization abbreviation
4. Cross-reference with `data/civilizations/civs-index.json` for attribName mappings
...
See [data/civilizations/civs-index.json](../data/civilizations/civs-index.json):
```json
{
  "ab": "abbasid_dynasty",
  "ay": "ayyubids",
...
| File | Size | Use Case |
|------|------|----------|
| [units/all.json](../data/units/all.json) | 117K lines | Full unit data, all civilizations |
| [units/all-unified.json](../data/units/all-unified.json) | 124K lines | Base units + `variations[]` nested structure (recommended for most lookups) |
| [buildings/all.json](../data/buildings/all.json) | 49K lines | Full building data, all civilizations |
| [buildings/all-baseids.json](../data/buildings/all-baseids.json) | Varies | Base ID cross-reference for building variants |
| [technologies/all.json](../data/technologies/all.json) | 96K lines | Full technology data, all civilizations |
