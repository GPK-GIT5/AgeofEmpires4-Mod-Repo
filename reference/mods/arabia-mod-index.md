...
|---------------|----------|---------------|
| Blueprint Resolution | `reference/blueprints/` | Verify attribName for AGS_ENTITY_TABLE |
| SCAR API Functions | `reference/scar-api-functions.md` | Function signature lookup |
| Constants & Enums | `reference/constants-and-enums.md` | ObjectiveType_*, ITEM_*, AGE_* |
| Data Index | `reference/data-index.md` | Unit stats and civilization data |
| Official Guides | `official-guides/02-editor-interface.md` | Content Editor workflow |
