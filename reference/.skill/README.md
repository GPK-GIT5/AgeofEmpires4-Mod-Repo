...
- **`../../data/units/all.json`** — Master unit blueprint list
- **`../../data/buildings/all.json`** — Master building blueprint list
- **`../../data/technologies/all.json`** — Master technology blueprint list
- **`../../data/civilizations/civs-index.json`** — Civilization mappings
...
- [SCAR API Functions](../scar-api-functions.md) — Blueprint functions
- [AoE4 World Data Index](../aoe4world-data-index.md) — Data structure documentation
- [Extraction Workflow](../extraction-workflow.md) — How source data is generated
