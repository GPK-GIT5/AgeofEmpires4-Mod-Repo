...
| Category | Location |
|----------|----------|
| Implementation | `reference/.skill/*.ts` |
| Build output | `reference/.skill/*.js` |
| Configuration | `reference/.skill/*.json` |
| Documentation | `reference/.skill/*.md` |
| Management | `scripts/manage-blueprint-cache.ps1` |
| Source data | `data/*/all.json` |
| Civilization index | `data/civilizations/civs-index.json` |
