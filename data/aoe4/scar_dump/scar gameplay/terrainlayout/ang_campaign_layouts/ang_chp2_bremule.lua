...
s = { terrainType = tt_plateau_low}
e = { terrainType = tt_plains_cliff}
...
--Bremule will play out on a SMALL map grid
terrainLayoutResult =
{ {p, p, p, p, p, p, p, r, p, g, g, b, p, b, d, d, d, h, h}
, {p, p, p, p, p, p, r, r, p, d, s, b, p, b, d, d, d, d, d}
, {p, p, p, p, p, r, r, p, d, d, s, b, p, b, b, d, d, d, d}
, {p, p, p, r, r, r, p, p, d, s, s, b, b, p, b, s, s, s, s}
, {p, p, r, r, p, p, d, e, s, s, s, s, b, b, b, s, s, s, s}
, {p, r, r, p, p, d, b, s, s, s, s, s, s, s, s, s, s, s, s}
, {p, r, p, p, d, b, s, s, s, s, s, s, s, s, s, s, s, s, s}
, {r, r, p, g, s, s, s, s, s, s, s, s, s, s, s, s, s, s, s}
, {p, p, d, d, s, s, s, s, s, s, s, s, s, s, s, s, s, s, s}
, {d, d, d, d, s, s, s, s, s, s, s, s, s, s, s, s, s, s, s}
, {h, d, d, s, s, s, s, s, s, s, s, s, s, s, s, s, s, s, s}
, {s, s, s, s, s, s, s, s, s, s, s, s, s, s, s, s, s, s, s}
, {d, b, b, b, b, b, b, b, b, s, s, s, s, s, s, s, s, s, s}
, {d, d, b, d, d, d, d, d, d, b, s, s, s, s, s, s, s, s, s}
, {p, p, p, p, p, p, p, p, p, p, s, s, s, s, s, s, s, s, s}
, {p, p, p, p, p, p, p, p, p, b, s, s, s, s, s, s, s, s, s}
, {p, p, p, p, p, p, p, p, p, b, b, s, s, s, s, s, s, s, s}
, {p, p, p, p, p, p, p, p, p, g, g, b, b, s, s, s, s, s, s}
, {p, p, p, p, p, p, p, p, p, g, g, g, s, s, s, s, s, s, s}	
}
...
ChartRiver(r, {8, 1}, terrainLayoutResult)
