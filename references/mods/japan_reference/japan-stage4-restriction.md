...
- `references/mods/japan-checkpoint-stage3.md` — Detailed rollback guide + verification steps
- `references/mods/CHECKPOINT-STAGE3-HASHES.json` — SHA256 checksums for integrity
- `references/mods/japan-checkpoint-stage3-manifest.md` — Line-by-line file breakdown
- `references/mods/japan-guide-api-reference.md` — Function quick reference
