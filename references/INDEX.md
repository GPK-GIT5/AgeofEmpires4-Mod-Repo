...
→ Start: `data/aoe4/scardocs/README.md` | Parsed: `data/aoe4/scardocs/parsed_functions.json` | Enriched: [scar-engine-api-signatures.md](api/scar-engine-api-signatures.md)
