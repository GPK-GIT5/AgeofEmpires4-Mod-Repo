...
|-------------|-----------|----------|
| `.scar` files | [scar-coding.instructions.md](scar-coding.instructions.md) | SCAR/Lua naming, APIs, console constraints |
| `.ps1` files | [ps-coding.instructions.md](ps-coding.instructions.md) | PowerShell script structure, patterns, validation |
| Files in `mods/` | [mods-scope.instructions.md](mods-scope.instructions.md) | File restrictions, index-first rule |
| Files in `gamemodes/` | [gamemode-scope.instructions.md](gamemode-scope.instructions.md) | Gamemode-specific restrictions |
| Anywhere in `mods/**` or `reference/mods/**` | [mod-context.instructions.md](mod-context.instructions.md) | Mod navigation, Japan & Arabia indexes |
...
- `"mods/**"` — All files under mods/ folder
...
Example: When editing a `.scar` file in `mods/Japan/`, Copilot loads **both** rules:
...
- **Research & decisions:** [../copilot/archive/2026-03/RESEARCH_FINDINGS_2026-03.md](../copilot/archive/2026-03/RESEARCH_FINDINGS_2026-03.md) *(archived)*
- **Implementation plan:** [../copilot/archive/2026-03/UPDATE_PLAN_2026-03.md](../copilot/archive/2026-03/UPDATE_PLAN_2026-03.md) *(archived)*
