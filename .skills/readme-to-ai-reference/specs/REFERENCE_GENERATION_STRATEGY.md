...
The AGS evaluation (see [_eval_report.md](../../Gamemodes/Advanced%20Game%20Settings/docs/ai/_eval_report.md)) produced outputs from both approaches, validating the mode framework:
...
- **AGS Eval Report:** [_eval_report.md](../../Gamemodes/Advanced%20Game%20Settings/docs/ai/_eval_report.md)
